...
feature: 001-muhsin_ai_robotics_book
branch: 001-muhsin_ai_robotics_book
user: anaslinux
command: /sp.plan
labels: ["planning", "architecture", "docusaurus", "textbook"]
links:
  spec: ../../specs/001-muhsin_ai_robotics_book/spec.md
  ticket: null
  adr: null
  pr: null
files:
  - specs/001-muhsin_ai_robotics_book/plan.md
  - specs/001-muhsin_ai_robotics_book/research.md
  - specs/001-muhsin_ai_robotics_book/data-model.md
  - specs/001-muhsin_ai_robotics_book/quickstart.md
  - specs/001-muhsin_ai_robotics_book/contracts/docusaurus-config.md
  - specs/001-muhsin_ai_robotics_book/contracts/chapter-template.md
  - specs/001-muhsin_ai_robotics_book/contracts/sidebar-structure.md
  - CLAUDE.md
tests:
...
"Textbook for Teaching **Muhsin Robotics Docs Course.**"
