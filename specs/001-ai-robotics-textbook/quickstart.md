...
git checkout 001-muhsin_ai_robotics_book
```
...
2. **Copy Chapter Template**:
   - Reference: `specs/001-muhsin_ai_robotics_book/contracts/chapter-template.md`
...
5. **Commit Changes**:
   ...
   git push origin 001-muhsin_ai_robotics_book
   ```
...
- **Contracts**: `specs/001-muhsin_ai_robotics_book/contracts/`
...
2. Read chapter template: `specs/001-muhsin_ai_robotics_book/contracts/chapter-template.md`
