...
sidebar_position: 1
description: "Introduction to the Muhsin Robotics Docs textbook - scope, approach, and learning philosophy"
keywords:
  - physical ai
  - humanoid robotics
  - textbook overview
...
This textbook was created using an AI-native workflow powered by **Claude Code** and **Spec-Kit Plus** methodology. See [How This Book Was Created](./how-created.md) for the complete development process.
...
See [How to Use This Book](./how-to-use.md) for detailed guidance on:
...
See [Who This Book Is For](./audience.md) for target audience details.

## Getting Started

Ready to begin? Start with:

- **[Requirements Overview](./requirements.md)** - Ensure you have necessary hardware/software
- **[Part I: Foundations](../01-physical-ai/index.md)** - Begin the learning journey
- **[Chapter 1: Introduction to Physical AI](../01-physical-ai/01-introduction.md)** - Dive into the first chapter
