...
sidebar_position: 3
description: "Target audience for the Muhsin Robotics Docs textbook"
keywords:
  - target audience
  - prerequisites
  - student background
...
See [Requirements Overview](./requirements.md) for detailed costs.
...
1. **Review [Requirements](./requirements.md)** - Ensure you have necessary resources
2. **Read [How to Use This Book](./how-to-use.md)** - Optimize your learning strategy
3. **Start [Chapter 1](../01-physical-ai/01-introduction.md)** - Dive into Physical AI
